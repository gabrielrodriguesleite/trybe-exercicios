...
// document.addEventListener('click', minhaF);
document.addEventListener('click', function (alvo) {
    for (let i of elementos) {
        if (i === alvo.target && !alvo.target.classList.contains('tech')) {
...
myWebpage.addEventListener('dblclick', function () {
    window.open('https://gabrielrodriguesleite.github.io');
});
